...
<div class="publication-card">
  <div class="publication-content">
    ...
    <div class="publication-venue">Entrepreneurship & Applied Research</div>
    <div class="publication-authors">Idris Houir Alami (Co-founder)</div>
    <div class="publication-year">2023 – Present</div>
    <div class="publication-description">
      Built an ML model for classifying game phases, achieving 87% accuracy while reducing annotation time by 10x. Collaborated with Ligue 1 club Stade de Reims and presented outcomes at ISPO STN Munich.
    </div>
    <div class="publication-tags">
      <span class="tag tag-conference">SPORTS AI</span>
      <span class="tag tag-workshop">APPLIED ML</span>
    </div>
  </div>
</div>
...
<div class="publication-card">
  <div class="publication-content">
    ...
    <div class="publication-venue">Industry Writing</div>
    <div class="publication-authors">Idris Houir Alami</div>
    <div class="publication-year">2025</div>
    <div class="publication-description">
      Authored an article on causal AI, combining interviews with domain experts and a review of relevant academic work.
    </div>
    <div class="publication-tags">
      <span class="tag tag-safety">CAUSAL AI</span>
      <span class="tag tag-workshop">VENTURE</span>
    </div>
  </div>
</div>
